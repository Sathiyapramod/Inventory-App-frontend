...
import { CADRE_IDS } from "../../helpers/constants";
    ...
    return (
        <div>
            ...
            <table className="table table-striped table-hover">
                <thead>
                    <tr>
                        {["#", "Employee Name", "Role Assigned", "Status"].map((element, index) => {
                    ...
                    {workflow &&
                        workflow.map((user, index) => {
                            return (
                                <tr key={index}>
                                    <td>{index + 1}</td>
                                    <td className="text-capitalize">{user.empName}</td>
                                    <td>
                                        {CADRE_IDS[user.cadreID]}
