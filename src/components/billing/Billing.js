    ...
    <div>
      ...
      <div>
        <table className="table table-hover">
          ...
          <tbody>
            {bills.length !== 0 ? (
              bills.slice(0, 10).map((billItem, index) => {
                return (
                  <tr key={index}>
                    <td>{index + 1}</td>
                    <td>
...
function ViewBilldetail(props) {
  ...
  return (
    <div
      ...
      aria-hidden="true"
    >
      {props.billdetails && <div className="modal-dialog modal-fullscreen">
          ...
          <div className="modal-body">
            ...
            <div className="d-flex flex-row justify-content-between align-items-center ps-2 pe-2">
              ...
              <label>Customer Name</label>
                  <span className="fs-3">{"BIL".concat(props.billdetails._id)}</span>
              </div>
                <div className="d-flex flex-row justify-content-start align-items-center gap-2">
                  <label>Customer Name</label>
                  <span className="fs-3">{props.billdetails.customerName}</span>
                </div>
                <div className="d-flex flex-row justify-content-start align-items-center gap-2">
